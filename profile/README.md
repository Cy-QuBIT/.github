...
This research applies quantum-hybrid machine learning techniques — including quantum-enhanced support vector machines — to detect anomalies in cyber-physical system data. Early results show improvements over classical methods in identifying cyber-attack signatures in high-dimensional datasets.
...
> #### 🔐 Crosstalk Attack Resilient Quantum Addition  
As quantum computing systems scale, shared environments introduce new security risks. This project investigates quantum crosstalk attacks on ion-trap qubits and proposes resilient quantum addition techniques using residue number systems to mitigate such threats.
